  ...
  <div id="content">
    ...
    <form action="" method="POST">
      <dl>
        ...
        <dt><?php print(htmlspecialchars($res_name,ENT_QUOTES)); ?><br><?php print(htmlspecialchars($res_message,ENT_QUOTES)); ?><br>へのコメント</dt>
        <input type="hidden" name="reply" value="<?php print(htmlspecialchars($res_name,ENT_QUOTES)); ?>">
        <?php else: ?>
        <dt><?php print(htmlspecialchars($member['name'], ENT_QUOTES)); ?>のつぶやき</dt>
        <?php endif; ?>
        <dd>
...
<?php foreach ($posts as $post): ?>
   ...
   ?>
       <p class="name"><?php print(htmlspecialchars($post['name'],ENT_QUOTES)); ?><span>-To　<?php print(htmlspecialchars($rep_about_name["name"],ENT_QUOTES)); ?></span>
    <?php else: ?>
    <p class="name"><?php print(htmlspecialchars($post['name'],ENT_QUOTES)); ?></p>
    <?php endif; ?>

    </p>
    <p><?php print(htmlspecialchars($post['message'], ENT_QUOTES)); ?>[<a href="index.php?res=<?php print(htmlspecialchars($post['id'],ENT_QUOTES)); ?>">Re</a>]</p>
